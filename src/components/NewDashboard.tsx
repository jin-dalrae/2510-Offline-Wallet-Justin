...
export function NewDashboard({
    ...
    const totalBalance = parseFloat(balance.available || '0');
                ...
                <div className="fixed inset-0 z-50 flex">
                    ...
                    <div className="relative w-64 bg-white h-full shadow-2xl animate-slide-right p-6 flex flex-col">
                        ...
                        <div className="flex flex-col items-center mb-8">
                            <div className="w-20 h-20 rounded-full overflow-hidden bg-slate-100 mb-3 ring-2 ring-slate-100">
                                {profilePicture ? (
                            ...
                            <h3 className="font-bold text-lg text-slate-900">{accountName}</h3>
                        </div>
                        ...
                        <nav className="space-y-4 flex-1">
                            ...
                            <button onClick={() => { setShowHistory(true); setShowMenu(false); }} className="w-full text-left px-4 py-3 hover:bg-slate-50 rounded-xl font-medium flex items-center gap-3">
                                <svg className="w-5 h-5 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-2xl mx-auto bg-gradient-to-b from-[#eaff7b] to-[#4bf2e6] rounded-3xl p-6 shadow-xl">
                ...
                <div className="mb-6 flex justify-between items-start">
                    ...
                    <div className="flex gap-2 items-center">
                        <div className={`flex items-center gap-2 rounded-full px-3 py-1 ${isOnline ? 'bg-green-100 text-green-700' : 'bg-slate-200 text-slate-600'}`}>
                        ...
                        <button
                            ...
                            className="p-2 hover:bg-white/50 rounded-full transition-colors flex items-center justify-center overflow-hidden"
                        >
                            {profilePicture ? (
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 shadow-sm">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="flex items-center gap-3">
                                <div className="w-12 h-12 rounded-full overflow-hidden bg-white/50 ring-2 ring-white/50">
                                    {profilePicture ? (
                                        <img src={profilePicture} alt="Profile" className="w-full h-full object-cover" />
                                    ) : (
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <button
                            ...
                            className="bg-slate-900 text-white rounded-2xl py-4 font-bold text-base shadow-lg shadow-slate-900/20 hover:scale-[1.02] active:scale-95 transition-all"
                        >
                            Send
                        </button>
                        <button
                    ...
                    {/* Off-line Allowance */}
                    <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 shadow-sm">
                        <h3 className="text-lg font-bold mb-2">Offline limit</h3>
                        ...
                        {isOnline ? (
                            <div className="space-y-3">
                                ...
                                <input
                                    ...
                                    className="w-full h-2 bg-slate-100 rounded-lg appearance-none cursor-pointer accent-[#1e3a5f]"
                                />
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500">EURC</p>
                                    </div>
                                </div>
                                <p className="font-mono font-bold">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500">cbBTC</p>
                                    </div>
                                </div>
                                <p className="font-mono font-bold">
                    ...
                    <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 shadow-sm min-h-[200px]">
                        ...
                        <div className="space-y-3 mb-4">
                            {loadingTxs ? (
                                ...
                                transactions.slice(0, 2).map((tx) => (
                                    <div key={tx.id} className="flex justify-between items-center bg-white/50 p-3 rounded-xl border border-white/50">
                                        <div className="flex items-center gap-3">
                                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-lg ${tx.type === 'received' ? 'bg-green-100 text-green-600' : 'bg-slate-100 text-slate-600'
                                                }`}>
                                                {tx.type === 'received' ? '↓' : '↑'}
                                            </div>
                                            <div>
                                        ...
                                        <div className="text-right">
                                            <p className={`font-mono font-bold text-sm ${tx.type === 'received' ? 'text-green-600' : 'text-slate-900'
                                                }`}>
                                                {tx.type === 'received' ? '+' : '-'}{tx.amount}
                                            </p>
                                            <p className="text-xs text-slate-500">{tx.tokenSymbol}</p>
                                        </div>
                                    </div>
                                ))
                            ) : (
                        ...
                        <button
                            ...
                            className="w-full py-3 text-sm font-bold text-slate-600 bg-white/50 hover:bg-white rounded-xl transition-colors"
                        >
